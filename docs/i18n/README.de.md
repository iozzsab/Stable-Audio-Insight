...
- NVIDIA-GPU mit CUDA 12.8 (getestet auf RTX 5080, 16 GB VRAM).
  Für andere GPUs den PyTorch-Index in `install.bat` / `setup.bat` anpassen
  (z. B. `cu121` für CUDA 12.1).
...
- **Wrapper-Entwicklung** — Oscar Lumiere
